...
class _FinancialGoalViewState extends State<_FinancialGoalView> {
                ...
                child: ListView(
                  children: [
                    ...
                    TableCalendar<TaskHiveModel>(
                      ...
                      leftChevronIcon: const Icon(Icons.chevron_left, color: Color.fromARGB(255, 255, 255, 255)),
                      rightChevronIcon: const Icon(Icons.chevron_right, color: Color.fromARGB(255, 255, 255, 255)),
                      ...
                      // ... (CalendarStyle, DaysOfWeekStyle)
                    ),
                    const SizedBox(height: 16),
                    _buildSelectedDayTasks(context, viewModel),
                    const SizedBox(height: 16),
                    _buildAddNoteField(
                        context, noteViewModel, viewModel.currentActiveGoal),
  ...
  Widget _buildDraggableTasks(
      BuildContext context, AIFinanceViewModel viewModel) {
    if (viewModel.draggableDailyTasks.isEmpty)
          ...
          return LongPressDraggable<TaskHiveModel>(
            ...
            childWhenDragging: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(14))),
            child:
                Padding(padding: const EdgeInsets.all(8.0), child: taskWidget),
          );
        },
      ),
    );
      ...
      onTap: () => showModalBottomSheet(
        ...
        builder: (context) => DraggableScrollableSheet(
          ...
          builder: (_, controller) =>
              const PlanRoadmapScreen(), // Assuming this screen is provided correctly
        ),
      ),
      child: Container(
